...
const roomInfoPopUp = document.getElementById('roomInfoPopUp');
const roomInfoBtn = roomInfoPopUp.querySelector('button');
const roomInfoText = roomInfoPopUp.querySelector('pre');
...
callInfoBtn.onclick = () => roomInfoClick();
